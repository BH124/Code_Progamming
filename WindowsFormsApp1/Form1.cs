...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        public static void inmenu()
        {
            ...
            Console.WriteLine("1.Add Motocrycle");
            Console.WriteLine("2.Edit Motocrycle");
            Console.WriteLine("3.Delete Motocrycle");
            Console.WriteLine("4.Make Motocrycle");
            Console.WriteLine("5.Year motocrycle");
            Console.WriteLine("6.Model motocrycle");
            Console.WriteLine("7.Price motocreycle");
            Console.WriteLine("8.Model motocrycle");
            Console.WriteLine("9.Find motocrycle by id");
        }
